  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between px-5 py-12 sm:p-24">
      <div className="z-10 w-full tracking-widest">
        <p>
          Every time talking over iPhone with the woman I was dating at the time, I tried to listen as attentive as possible. She indeed has expressed sincere gratitude multiple times, but the behavior does not come from my nature but an effort to be popular with her. I followed the advice written in a love book such as <span className="italic">Men Are from Mars, Women Are from Venus</span>. However, maybe because I naturally enjoy learning new things, I could enjoy attentive listening, so I often put it into practice because she and I both genuinely liked it.
          <br/>
          <br/>
          Though I do not have a strong desire for others to listen to me, when I chat with friends I sometimes feel that the jumbled thoughts in my head get organized. Unexpected words from my friends can give birth to ideas, and the support or opposition from my companions can give me confidence in my own thoughts or prompt me to reconsider whether it is really a good idea. That is why coffee breaks are something I love so much and cherish. Additionally as someone who cannot help taking lots of notes, once I part ways with my friends, I always immediately jot down the things that resonated with me before I forget.
          <br/>
          <br/>
